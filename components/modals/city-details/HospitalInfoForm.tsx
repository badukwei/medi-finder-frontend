...
const HospitalInfoForm: React.FC<HospitalInfoFormProps> = ({
	hospital,
	onChange,
	onSave,
}) => {
				...
				<fieldset className="box-fieldset mb-0">
					...
					<div className="form-check">
						<input
							...
							onChange={() =>
								handleInputChange("open24Hours", true)
							}
						/>
						<label
							htmlFor={`open24Hours-yes-${hospital.id}`}
					...
					<div className="form-check">
						<input
							...
							onChange={() =>
								handleInputChange("open24Hours", false)
							}
						/>
						<label
							htmlFor={`open24Hours-no-${hospital.id}`}
							className="form-check-label fw-5 m-0"
						>
							No
						</label>
